...
Controller Description: Authentication add-on controller for the Wordpress Android and iOS App plugin for WooCommerce by WSD plugin
Controller Author: Matt Berg, Ali Qureshi
Controller Author Twitter: @parorrey
*/


class WSDAI_JSON_API_Auth_Controller {
