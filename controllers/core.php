...
class WSDAI_JSON_API_Core_Controller {
  ...
  public function get_post() {
    ...
    if ($post) {
      ...
      $response = array(
        'post' => new WSDAI_JSON_API_Post($post)
      );
      if ($previous) {
  ...
  public function get_page_index() {
    ...
    foreach ($wp_posts as $wp_post) {
      $pages[] = new WSDAI_JSON_API_Post($wp_post);
    }
  ...
  protected function posts_object_result($posts, $object) {
    global $wp_query;
    // Convert something like "WSDAI_JSON_API_Category" into "category"
