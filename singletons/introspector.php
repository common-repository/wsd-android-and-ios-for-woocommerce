...
class WSDAI_JSON_API_Introspector {
  ...
  public function get_posts($query = false, $wp_posts = false) {
    ...
    while (have_posts()) {
      ...
      if ($wp_posts) {
        ...
        $new_post = new WSDAI_JSON_API_Post($post);
      }
      $output[] = $new_post;
    }
    return $output;
  ...
  public function get_author_by_id($id) {
    ...
    return new WSDAI_JSON_API_Author($id);
  }
  ...
  public function get_comments($post_id) {
    ...
    foreach ($wp_comments as $wp_comment) {
      $comments[] = new WSDAI_JSON_API_Comment($wp_comment);
    }
    return $comments;
  }
  ...
  public function get_attachments($post_id) {
    ...
    if (!empty($wp_attachments)) {
      foreach ($wp_attachments as $wp_attachment) {
        $attachments[] = new WSDAI_JSON_API_Attachment($wp_attachment);
      }
    }
    return $attachments;
  }
  ...
  public function get_attachment($attachment_id) {
    ...
    return new WSDAI_JSON_API_Attachment($wp_attachment);
  }
  ...
  public function attach_child_posts(&$post) {
    ...
    foreach ($wp_children as $wp_post) {
      $new_post = new WSDAI_JSON_API_Post($wp_post);
  ...
  protected function get_category_object($wp_category) {
    ...
    return new WSDAI_JSON_API_Category($wp_category);
  }
  ...
  protected function get_tag_object($wp_tag) {
    ...
    return new WSDAI_JSON_API_Tag($wp_tag);
  }
  ...
  protected function set_posts_query($query = false) {
    ...
    if (!empty($query)) {
      query_posts($query);
      do_action('WSDAI_json_api_query', $wp_query);
    }
  }
